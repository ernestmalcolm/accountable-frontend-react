        ...
        <>
            ...
            <section className="mt-10 relative">
                <div className="flex flex-wrap gap-y-10 gap-x-5 justify-center items-center lg:justify-between w-full">
                            ...
                            <div className="bg-[#E1E1E180] dark:bg-[#2E2E2E] border-b-[0.5px] border-b-[#0D0D0D0D] dark:border-b-gray-500 rounded-tl-xl rounded-tr-xl p-3 flex justify-between items-center">
                                <div className="flex flex-col gap-y-1">
                                    ...
                                    <div className="flex items-center gap-x-2">
                                        ...
                                        <p className="bg-[#CDCDCD] dark:bg-accountableDarkBlack p-1 rounded-lg line-clamp-1 ... text-xs">
                                            INV # NUMBER
                                        </p>
                                    </div>
                                </div>
                    ...
                    <button
                        className="bg-transparent dark:text-accountableBrightGreen rounded-lg w-auto p-2 text-lg"
                        onClick={() => {}}
                    >
                ...
                {isUploading && (
                    <div className="bg-[#CDCDCD] dark:bg-[#323232] rounded-xl w-full lg:w-[45%] absolute top-0 left-0 z-[5] p-5">
                        <div className="flex justify-center">
                            <h3 className="text-xl text-center flex items-center justify-center h-10 w-44 p-3 bg-[#E1E1E180] dark:bg-accountableDarkBlack">
                                NEW EXPENSE
                            </h3>
                        </div>
