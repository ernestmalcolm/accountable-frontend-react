        ...
        datasets: [
            {
                label: "",
                data: [
                    0, 1000, 10000, 20000, 50000, 150000, 3000, 6000, 30000,
                    120000, 85000, 15000,
                ],
            ...
            },
            {
                label: "",
                data: [
                    20000, 40000, 10000, 4000, 25500, 20000, 17000, 20000,
                    100000, 50000, 20000, 150000,
                ],
                backgroundColor: "transparent",
                borderColor: "#F974561A",
                pointBorderColor: "transparent",
                pointBorderWidth: 4,
                tension: 0.3,
            },
    ...
    const lineOptions = {
        ...
        scales: {
            x: {
                ...
                // ticks: {
                //     color: "#0D0D0D80", // Change this to the desired font color
                // },
            },
        ...
        <>
            ...
            <section className="mt-10 relative">
                <div className="flex flex-wrap gap-y-10 gap-x-5 justify-center items-center lg:justify-between w-full">
                    <div className="border-[2px] border-[#CDCDCD] dark:border-[#323232] w-[230px] rounded-lg p-5 flex flex-col gap-y-4 justify-between items-center">
                        <img
                            src={services}
                            alt=""
                ...
                <div className="w-full p-10 mt-20 border-[2px] border-[#CDCDCD] dark:border-[#323232] shadow-md rounded-xl ">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                        <div className="">
                            <p className="font-bold text-accountableDarkBlack dark:text-[#fff] text-xl">
                                Profits & Losses
                            </p>
                        ...
                        <div className="flex flex-col gap-y-4 items-start lg:items-end my-4 lg:my-0">
                            <div className="flex items-center gap-x-4">
                                ...
                                <div className="flex flex-col lg:items-end gap-x-2 text-accountableBrightGreen">
                                    <p className="font-bold text-xl text-accountableDarkBlack dark:text-[#fff]">
                                        USD $26,500
                                    </p>
                                    <div className="flex items-center gap-x-1 text-accountableDarkGreen dark:text-accountableBrightGreen">
                            ...
                            <div className="flex items-center flex-wrap gap-y-2 gap-x-2 mt-2 lg:mt-0">
                                ...
                                <button
                                    ...
                                    onClick={() =>
                                        toggleChartStates("three-months")
                                    }
                                >
                                    Three Months
                                </button>
                ...
                <div className="w-full p-10 border-[2px] border-[#CDCDCD] dark:border-[#323232] shadow-md rounded-xl mt-20">
                    <div className="flex flex-col items-start gap-y-2 lg:flex-row lg:items-center lg:justify-between mb-6">
                        <p className="font-bold text-xl font-bold text-accountableBlack dark:text-[#fff]">
                            Transactions
                        </p>
                        <div className="flex flex-col gap-y-3 items-start lg:flex-row lg:items-center gap-x-5">
                            <div className="flex items-center gap-x-4">
                                <div className="flex items-center gap-x-2">
                                    ...
                                    <div
                                        className="h-10 w-24 flex justify-center items-center p-2 border-[#CDCDCD] dark:border-[#323232] border-[1px] rounded-lg cursor-pointer"
                                        onClick={() => {}}
                                    >
                                        <p className="text-gray-500 text-xs">
                                            14/08/2024
                            ...
                            <div className="flex flex-col items-start lg:items-end">
                                ...
                                <p className="text-xl text-accountableDarkGreen dark:text-accountableBrightGreen">
                                    $16,000.00
                                </p>
                    ...
                    <hr className="border-[#CDCDCD] dark:border-[#323232]" />
                    ...
                    <div className="">
                        ...
                        <div className="flex items-center justify-between my-7">
                            <div className="flex flex-col gap-y-1">
                                <p className="font-bold text-accountableBlack dark:text-[#fff]">
                                    Salary
                                </p>
                            ...
                            <div className="h-10 w-36 border-[1px] border-[#CDCDCD] dark:border-[#323232] rounded-lg flex items-center justify-center">
                                <div className="flex items-center gap-x-2">
                                    <div className="h-2 w-2 rounded-full bg-accountableBrightGreen"></div>
                                    <small className="font-bold text-accountableBlack dark:text-[#fff]">
                                        Transportation
                                    </small>
                                </div>
                            </div>

                            <div className="h-10 w-10 bg-[#CDCDCD] dark:bg-[#323232] rounded-lg  flex items-center justify-center">
                                <AiOutlineArrowDown
                                    size={24}
                                    className="font-bold text-accountableBlack dark:text-[#fff] rotate-45"
                                />
                            </div>
                            <p className="font-bold text-accountableBlack dark:text-[#fff]">
                                $3,797.96
                ...
                <div className="w-full mt-20">
                    ...
                    <div className="flex flex-col gap-y-10 lg:flex-row lg:items-start gap-x-3">
                        {/* DUE PAYMENTS */}
                        <div className="border-[2px] rounded-xl p-10 border-[#CDCDCD] dark:border-[#323232] w-full lg:w-[35%]">
                            <div className="flex flex-col items-start gap-y-2 lg:flex-row lg:items-center lg:justify-between mb-6">
                                <p className="font-bold font-bold text-accountableBlack dark:text-[#fff]">
                                    Payments Due
                                </p>
                            </div>
                        ...
                        {/* RECEIVABLE INVOICES */}
                        <div className="border-[2px] rounded-xl p-10 border-[#CDCDCD] dark:border-[#323232] w-full lg:w-[65%]">
                            <div className="flex flex-col items-start gap-y-2 lg:flex-row lg:items-center lg:justify-between mb-6">
                                <p className="font-bold font-bold text-accountableBlack dark:text-[#fff]">
