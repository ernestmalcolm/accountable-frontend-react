...
function Dashboard(props) {
    ...
    useEffect(() => {
        async function validateSession() {
            ...
            await axios
                .post(
                    `${process.env.NEXT_PUBLIC_BASE_URL_API}/users/verifyToken`,
                    {
                        token,
                    }
                )
    ...
    return (
        ...
        >
            ...
            {/* BODY */}
            <DahboardTopBar />
            <div className="p-10 lg:pl-[25%] scrollbar-thin bg-accountableLightBackground dark:bg-accountableBlack text-accountableBlack dark:text-[#fff] min-h-screen ">
                {props.children}
            </div>
        </UserContext.Provider>
    );
