            ...
            <section className="mt-10 relative">
                <div className="flex flex-wrap gap-y-10 gap-x-5 justify-center items-center lg:justify-between w-full">
                    <div className="flex items-center justify-between w-full">
                        ...
                        <p className="font-bold text-lg text-accountableBlack dark:text-[#fff]">
                            Transaction
                        </p>

                        <button
                            className="bg-accountableDarkGreen text-[#fff] rounded-lg w-28 h-10 p-2 text-sm"
                            onClick={() => {}}
                            disabled
                        >
                            New
                ...
                <div className="w-full p-10 border-[2px]  border-[#CDCDCD] dark:border-[#323232] shadow-md rounded-xl mt-10">
                    ...
                    <div className="flex flex-col gap-y-3 items-start lg:flex-row lg:items-center gap-x-5 my-5">
                        <div className="flex lg:flex-row lg:items-center lg:justify-between w-full flex-col gap-y-5">
                            <select
                                ...
                                className=" border-[#CDCDCD] dark:border-[#323232] border-[1px] bg-transparent text-gray-500 rounded-lg w-auto h-10 p-2 text-xs"
                            >
                    ...
                    <div className="flex items-center justify-center lg:justify-between flex-wrap">
                        <div className="p-5 rounded-xl border-[2px]  border-[#CDCDCD] dark:border-[#323232] h-20 w-[310px] flex items-center justify-between">
                            <div className="flex items-center gap-x-2">
                                <div className="h-14 w-14 bg-[#CDCDCD] dark:bg-[#323232] rounded-lg  flex items-center justify-center">
                                    <AiOutlineArrowDown
                                        size={24}
                                        className="text-accountableLightBasicColor dark:text-accountableBrightGreen rotate-45"
                                    />
                                </div>
