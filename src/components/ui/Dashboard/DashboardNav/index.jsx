...
export default function DashboardNav({ isNavHidden, user, page }) {
    ...
    return (
        <nav
            className={`bg-accountableLightBackground border-r-2 border-[#0D7073] dark:bg-accountableDarkBlack md:w-1/4 lg:w-1/5 z-10 fixed w-2/4 min-h-screen lg:block text-accountableBrightGreen pl-2 pt-7 top-0 left-0 ${
        ...
        >
            ...
            <ul className="-mt-0">
                ...
                <li className="my-11">
                    {/* ITEMS */}
                    <ul className="mt-3 text-accountableBlack dark:text-accountableBrightGreen">
                        <li
                        ...
                        <li
                            className={`my-8 ml-7 py-2 pl-3 rounded-l-lg text-red-500`}
                        >
