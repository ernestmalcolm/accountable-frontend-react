    ...
    return (
        <>
            ...
            <div className="flex justify-between">
                <div className="border-[.5px] border-gray-400 dark:border-[#fff] p-7 h-[600px] w-full relative rounded-lg">
                    <div className="border-b-[.5px] border-gray-400 dark:border-[#fff] pb-3">
                        ...
                        <div className="flex gap-1">
                            ...
                            <p className="text-xs my-auto mt-[1.5px]">
                                Active now
                            </p>
                        </div>
                        {/* <div className="flex gap-1">
            ...
            <p className="text-xs my-auto mt-[1.5px]">Offline</p>
                    ...
                    >
                        <div className="flex h-12 align-middle border-[.5px] border-gray-400 dark:border-[#fff] px-4">
                            <input
                                type="text"
                                name="message"
                                value={newMessage}
                                ...
                                className="w-full bg-transparent h-full border-gray-400  px-8  text-sm rounded-lg rounded-bl-lg focus:outline-none"
                            />
